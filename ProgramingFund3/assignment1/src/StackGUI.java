...
public class StackGUI extends JPanel {
    ...
    public StackGUI()
    {
        ...
        lblAuthor = new JLabel("This program was written by Dr. Brandon Ashworth");
    ...
    private class CompleteListener implements ActionListener
    {
        public void actionPerformed(ActionEvent event)
        {
            ...
            for(i= 0; i <strLength; i++){
                if(myStack.full()){
                    JOptionPane.showMessageDialog(null, "Can't push the character "+text.charAt(i)+"on to the stack","ERROR",JOptionPane.ERROR_MESSAGE);
                }else{
                    if(text.charAt(i)!= ' '){

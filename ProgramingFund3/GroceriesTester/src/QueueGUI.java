...
public class QueueGUI extends JPanel {
    ...
    private class QueueListener implements ActionListener
    {
        public void actionPerformed (ActionEvent event)
        {
            ...
            if(source == rbtEnqueue){
                enqueueShopper();

            }else if(source == rbtDequeue){
                dequeueShopper();

            }else if (source == rbtDisplay){
    ...
    {
        if(shoppers.emptyShoppers() == false){
            ...
            JOptionPane.showMessageDialog(null,"Couldn't dequeue a shopper from the queue since it is empty","Error",JOptionPane.ERROR_MESSAGE);
        }

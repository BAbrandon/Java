...
public class StudentTester {
	...
	public static void main(String[] args) {
		...
		Address school = new Address ("800 Lancaster Ave",
			...
			// option panes
			street = JOptionPane.showInputDialog(null, 
					"Please enter street");
			town = JOptionPane.showInputDialog(null, 
					"Please enter town");
			state = JOptionPane.showInputDialog(null, 
					"Please enter state");
			zipCodeText = JOptionPane.showInputDialog(null, 
			...
			testScore1Text = JOptionPane.showInputDialog(null, 
					"Please enter the test score for test 1 for "+firstName);
			testScore1 = Integer.parseInt(testScore1Text);
			
			testScore2Text = JOptionPane.showInputDialog(null, 
					"Please enter the test score for test 2 for "+firstName);
			testScore2 = Integer.parseInt(testScore2Text);
			
			testScore3Text = JOptionPane.showInputDialog(null, 
					"Please enter the test score for test 3 for "+firstName);
			...
			testScore2Text = JOptionPane.showInputDialog(null, 
					"Please enter the updated test 2 test score for "+firstName);
			testScore2 = Integer.parseInt(testScore2Text);
			...
			JOptionPane.showMessageDialog(null,
					firstName + "'s second test score is now "+ myStudent.getTestScore(2));
